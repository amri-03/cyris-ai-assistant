...
* a task manager
* a dashboard-heavy system
* a CRUD-focused website
* a motivational assistant

The goal is to create an intelligent system that gradually understands the user over time through:
...
* recover from inconsistency faster
